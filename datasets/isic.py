...
class ISICTestDataset(Dataset):
    ...
    def __init__(
        ...
        self.files = list(
            sorted(
                glob.glob(f"{path}/{category}/test/ISBI2016_ISIC_Part1_Test_Data/*.jpg")
            )
        )
    ...
    def __getitem__(self, index):
        ...
        mask_path = file.replace(
            "test/ISBI2016_ISIC_Part1_Test_Data", "ISBI2016_ISIC_Part1_Test_GroundTruth"
